...
public class FKks {
    ...
    @Excel(name = "颜色",width = 20,height = 20,readConverterExp = "1=红底白字,2=蓝底白字,3=绿底白字,4=白底黑字,5=其他")
    private String color;
    @Excel(name = "其他颜色",width = 20,height = 20)
    private String oColor;
    @Excel(name = "标识内容",width = 30,height = 20)
    private String signangeContent;
    @Excel(name = "位置",width = 20,height = 20)
    private String position;
    @Excel(name = "数量",width = 10,height = 20)
    private Integer sCount;
    @Excel(name = "备注",width = 30,height = 20)
